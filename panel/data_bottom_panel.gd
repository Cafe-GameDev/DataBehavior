...
func _populate_item_list():
	...
	var resource_files = _get_files_recursive("res://addons/data_behavior/resources/", ".tres")
	for file_path in resource_files:
		resource_item_list.add_item(file_path.replace("res://addons/data_behavior/resources/", ""))

	script_item_list.clear()
	var script_files = _get_files_recursive("res://addons/data_behavior/scripts/", ".gd")
	for script_path in script_files:
		var script = load(script_path)
		if script and script is Script and ClassDB.is_parent_class(script.get_instance_base_type(), "Resource"):
			script_item_list.add_item(script_path.replace("res://addons/data_behavior/scripts/", ""))
...
func _on_create_resource_button_pressed():
	...
	file_dialog.current_path = "res://addons/data_behavior/resources/"
...
func _on_remove_resource_button_pressed():
	...
	if selected_items.size() > 0:
		...
		var resource_path = "res://addons/data_behavior/resources/" + selected_item_name
...
func _on_edit_resource_button_pressed():
	...
	if selected_items.size() > 0:
		...
		if resource:
			var modal = load("res://addons/data_behavior/panel/data_modal_panel.tscn").instantiate()
...
func _on_create_script_button_pressed() -> void:
	var file_dialog = FileDialog.new()
	file_dialog.title = "Criar Novo Script de DataBehavior"
	file_dialog.file_mode = FileDialog.FILE_MODE_SAVE_FILE
	file_dialog.access = FileDialog.ACCESS_RESOURCES
	file_dialog.current_path = "res://addons/data_behavior/scripts/"
	...
	file_dialog.confirmed.connect(func():
		...
		var script_template = """
extends DataBehavior
class_name NewDataBehavior
"""
...
func _on_remove_script_button_pressed() -> void:
	...
	if selected_items.size() > 0:
		...
		var script_path = "res://addons/data_behavior/scripts/" + selected_item_name
		var dialog = ConfirmationDialog.new()

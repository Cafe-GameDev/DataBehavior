...
const DOCS : String = "https://www.cafegame.dev/cafeengine/databehavior"
const ARROW_BIG_DOWN_DASH = preload("res://addons/data_behavior/icons/arrow-big-down-dash.svg")
const ARROW_BIG_UP_DASH = preload("res://addons/data_behavior/icons/arrow-big-up-dash.svg")

@export var data_config: DataConfig = preload("res://addons/data_behavior/resources/data_config.tres")
